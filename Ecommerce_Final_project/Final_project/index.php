...
<head>
    ...
    <style>
        body {
            background-color: #f0f8ff; /* Light sky blue for a cheerful atmosphere */
            font-family: 'Comic Sans MS', cursive, sans-serif; /* Fun, playful font */
        }
        .brand-link {
            background-color: #ff4081; /* Bright pink for toy store theme */
        ...
        .main-footer {
            background-color: #ffcc80; /* Light orange footer */
            color: black;
            text-align: center;
            padding: 10px;
            font-size: 16px;
        ...
        .content-wrapper {
            background-color: #fffbe6; /* Soft yellow for a playful vibe */
            padding: 40px;
            border-radius: 10px;
        }
        .alert {
            background-color: #ffecb3; /* Highlight box color */
            color: #ff6f00;
            border-radius: 10px;
            padding: 20px;
            font-size: 18px;
